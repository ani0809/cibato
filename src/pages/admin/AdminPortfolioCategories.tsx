...
const AdminPortfolioCategories = () => {
    ...
    const loadCategories = async () => {
        try {
            const res = await fetchWithAuth('/portfolio-categories');
            if (res.ok) {
    ...
    const handleDelete = async (id: string) => {
        ...
        try {
            await fetchWithAuth(`/portfolio-categories/${id}`, { method: 'DELETE' });
    ...
    const handleUpdate = async () => {
        ...
        setSubmitting(true);
        try {
            const res = await fetchWithAuth(`/portfolio-categories/${editingCategory.id}`, {
                method: 'PUT',
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                ...
                                <p className="text-xs text-slate-500 mt-1">
                                    The name is how it appears on your portfolio items.
                                </p>
                            </div>
