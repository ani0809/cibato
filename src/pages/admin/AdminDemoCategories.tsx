...
import { Trash2, Tag, Edit, X, Save } from 'lucide-react';
...
const AdminDemoCategories = () => {
    ...
    const loadCategories = async () => {
        try {
            const res = await fetchWithAuth('/demo-categories');
            if (res.ok) {
    ...
    const handleDelete = async (id: string) => {
        ...
        try {
            await fetchWithAuth(`/demo-categories/${id}`, { method: 'DELETE' });
    ...
    const handleUpdate = async () => {
        ...
        setSubmitting(true);
        try {
            const res = await fetchWithAuth(`/demo-categories/${editingCategory.id}`, {
                method: 'PUT',
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                ...
                                <p className="text-xs text-slate-500 mt-1">
                                    The category name for grouping demos.
                                </p>
                            </div>
...
export default AdminDemoCategories;
